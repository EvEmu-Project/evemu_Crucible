...
ELSE ( WIN32 )
  IF( CMAKE_SIZEOF_VOID_P EQUAL 8 )
    # Linux 64-bit
    SET( PKG_NAME "mariadb-11.4.5-linux-systemd-x86_64" )
    SET( PKG_MD5 "410f073f591308072495431539d68400" )
    SET( MYSQL_DOWNLOAD_URL "https://archive.mariadb.org///mariadb-11.4.5/bintar-linux-systemd-x86_64/mariadb-11.4.5-linux-systemd-x86_64.tar.gz")
  ELSE()
    # Linux 32-bit
