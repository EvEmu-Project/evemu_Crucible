...
#ifndef __XML_PARSER_EX__H__INCL__
#define __XML_PARSER_EX__H__INCL__
 ...
 */
template<>
class XMLParserEx::ValueParser<std::string>
: public ElementParser
{
public:
    /** Type of parsed value. */
...
#endif /* !__XML_PARSER_EX__H__INCL__ */
