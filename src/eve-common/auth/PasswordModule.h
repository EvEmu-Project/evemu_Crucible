...
public:
    ...
    /**
     * @brief Generates a versioned Argon2id verifier record.
     *
     * The credential is the client-compatible credential value. A random
     * per-record salt is generated by the operating system CSPRNG.
     */
    static bool GenerateArgon2idVerifier(
        const std::string& credential,
        std::string& verifier );

    /**
     * @brief Verifies a client-compatible credential against an Argon2id record.
     */
    static bool VerifyArgon2idVerifier(
        const std::string& credential,
        const std::string& verifier );

    /**
     * @brief Verifies a KDF record, or a legacy fixed-length hash.
     *
     * A non-empty verifier always takes precedence over the legacy hash.
     */
    ...
    /**
     * @brief Generates cryptographically random hexadecimal text.
     */
    static bool GenerateSecureRandomHex(
