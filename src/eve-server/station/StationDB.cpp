...
uint32 StationDB::CreateOffice(ItemData& idata, OfficeData& odata)
{
    ...
    if (!sDatabase.RunQueryLID(err, uid,
        ...
        " VALUES"
        " (%u,%u,%u,%u,%u,%u, 27, %u,%u,%u,%li)",
        odata.name, odata.corporationID, odata.stationID, odata.folderID, idata.flag, stDataMgr.GetStationSystemID(odata.stationID), odata.typeID, odata.lockDown, odata.rentalFee, odata.expiryTime)
    )
