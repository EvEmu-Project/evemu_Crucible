...
{
// MS Visual Studio supports inline assembly only on 32-bit platforms
#if defined( MSVC ) && defined( X86 )
    ...
    __asm
    {
        ...
        mov ecx, crc32              // Load crc32

        lea edi, CRC32_LOOKUP_TABLE // Load the CRC32 table
    ...
    crc32loop:
        ...
        mov crc32, ecx              // Write the result
    }
